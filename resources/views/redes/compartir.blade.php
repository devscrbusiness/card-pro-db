<x-app-layout>
            ...
            <div class=" overflow-hidden shadow-sm rounded-lg bg-white">
                ...
                <div class="flex justify-center">
                    ...
                    <div class="flex-col justify-center text-sm mt-6 mb-6 gap-6">
                        ...
                        @if($red->red_id == 1)
                        <div class="flex md:justify-between px-6 py-2">
                            ...
                            <strong class="flex justify-center items-center px-6 text-lg">
                                <a class="red-link" href="{{ $red->descripcion }}">
                                </a>
                            </strong>
                        </div>
                        @elseif($red->red_id == 2)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const redesLinks = document.querySelectorAll('.red-link');
