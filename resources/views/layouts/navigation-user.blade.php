<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 rounded-lg flex justify-center items-center">
    <div class="flex justify-center bg-white rounded-lg">
        <!-- Redes -->
        <div class="flex justify-center text-sm p-6 gap-6">
            <a href="/compartir/{{ $user->login_token }}">
